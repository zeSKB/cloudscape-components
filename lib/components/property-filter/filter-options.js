...
const matchWithoutDiacritics = (value, searchText) => {
    return ((value === null || value === void 0 ? void 0 : value.toLowerCase().normalize('NFKD').replace(/\p{Diacritic}/gu, '').indexOf(searchText)) !== -1);
};
