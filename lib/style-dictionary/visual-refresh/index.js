...
exports.buildVisualRefresh = void 0;
...
const alert_1 = __importDefault(require("./contexts/alert"));
const header_alert_1 = __importDefault(require("./contexts/header-alert"));
const modes = [
...
function buildVisualRefresh(builder) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    builder.addContext((0, contexts_1.createHeaderContext)(require('./contexts/header').tokens));
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    builder.addContext((0, contexts_1.createFlashbarContext)(require('./contexts/flashbar').tokens));
    builder.addContext({
        id: 'alert',
        selector: '.awsui-context-alert',
        tokens: alert_1.default,
    });
    builder.addContext({
        id: 'alert-header',
        selector: '.awsui-context-content-header .awsui-context-alert',
        tokens: header_alert_1.default,
    });
    return builder.build();
}
exports.buildVisualRefresh = buildVisualRefresh;
const builder = new theming_build_1.ThemeBuilder('visual-refresh', ':root', modes);
