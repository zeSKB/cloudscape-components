...
const metadata = {
    ...
    spaceScaledXl: {
        description: 'The XL spacing unit which scales between modes. For example: vertical space between tasks in a tutorial panel.',
        public: true,
        themeable: false,
    },
    spaceScaledXs: {
    ...
    spaceScaledXxl: {
        description: 'The XXL spacing unit which scales between modes. For example: left indentation of grouped options in a select.',
        public: true,
        themeable: false,
    },
    spaceScaledXxs: {
    ...
    spaceScaledXxxs: {
        description: 'The XXXS spacing unit which scales between modes. For example: vertical space between key label and value in key/value pairs.',
        public: true,
        themeable: false,
    },
